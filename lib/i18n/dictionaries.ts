...
export const dictionaries = {
  en: {
    ...
    results: {
      ...
      shareHorizontal: "Horizontal Image (Desktop/Tablet)",
      shareVertical: "Vertical Image (Mobile-friendly)",
    ...
    community: {
      ...
      deleteConfirmTitle: "Delete Upload?",
      deleteConfirmDesc: "This will permanently remove your list from the community board and reset all likes. This cannot be undone.",
    ...
    about: {
      ...
      algorithmOptimalDesc: "For N=200 and K=10, you need only ~271 matchups — 85% fewer than fully sorting all films.",
      ...
      listImdb: "IMDb Top 250 — updated July 9, 2026",
      listLetterboxd: "Letterboxd Top 500 — updated July 9, 2026",
      listDouban: "Douban Top 250 — updated July 9, 2026",
  ...
  zh: {
    ...
    results: {
      ...
      restart: "重新开始",
      share: "下载图片",
      shareHorizontal: "横向图片 (电脑/平板)",
      shareVertical: "纵向图片 (手机/移动端)",
      shareGenerating: "生成中...",
    ...
    community: {
      ...
      deleteConfirmDesc: "这将永久删除你在社区的榜单并清零所有点赞，操作不可撤销。",
    ...
    about: {
      ...
      listImdb: "IMDb Top 250 — 更新于 2026 年 7 月 9 日",
      listLetterboxd: "Letterboxd Top 500 — 更新于 2026 年 7 月 9 日",
      listDouban: "豆瓣 Top 250 — 更新于 2026 年 7 月 9 日",
